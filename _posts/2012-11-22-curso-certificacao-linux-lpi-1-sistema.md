...
image: '/assets/img/lpi/boot-process-chart-terminalroot'
...
![Curso Certificação Linux LPI-1: Sistema de Boot, Shutdown e Runlevels](/assets/img/lpi/boot-process-chart-terminalroot "Curso Certificação Linux LPI-1: Sistema de Boot, Shutdown e Runlevels")
